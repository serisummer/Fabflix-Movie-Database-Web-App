...
public class DashboardLoginServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            jsonObject.addProperty("message", "failed captcha " + e.getMessage());
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            if (rs.next()) {
                ...
                if (new StrongPasswordEncryptor().checkPassword(password,resPassword)) {
                    ...
                    if (session.getAttribute("employee") == null) {
                        session.setAttribute("employee", new User(username, name));
                    }
            ...
            JsonObject jsonObject = new JsonObject();
            jsonObject.addProperty("message", "connection failed" + e.getMessage());
            out.write(jsonObject.toString());
